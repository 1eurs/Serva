...
const DICT: Dict = {
  ar: {
    ...
    g_front: 'واجهة الخدمة', g_catalog: 'القائمة والمخزون والطاولات', g_manage: 'الإدارة',
    ...
    p_STOCK: 'المخزون', h_STOCK: 'ما في المخزون، تسجيل الواصل وتصحيح العدد',
  ...
  en: {
    ...
    g_front: 'Front of house', g_catalog: 'Menu, stock & tables', g_manage: 'Management',
    ...
    p_STOCK: 'Stock', h_STOCK: 'What’s on the shelf, logging deliveries & fixing counts',
...
const PERM_GROUPS: { key: string; perms: Permission[] }[] = [
  ...
  { key: 'g_catalog', perms: ['MENU', 'STOCK', 'QR_TABLES'] },
